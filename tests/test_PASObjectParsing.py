...
class Test_PASObjReader(unittest.TestCase):
	...
	def test_modify_1000(self):
		...
		data_10000_modified = self.objReader["10000"].modifyData(data_10000, "xEAES_Used", "15")
		...
		data_10000_modified = self.objReader["10000"].modifyData(data_10000_modified, "eBoard_slot", "12", 4)
		...
		data_10000_modified = self.objReader["10000"].modifyData(data_10000_modified, "tSubSlotType", "AA", 0)
		...
		data_10000_modified = self.objReader["10000"].modifyData(data_10000_modified, "tSubSlotType", "BAC", 0)
