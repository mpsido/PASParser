...
print("\nModify data")
data_10000_modified = objReader["10000"].modifyData(data_10000, "xEAES_Used", "15")
data_10000_modified = objReader["10000"].modifyData(data_10000_modified, "eBoard_slot", "12", 4)
